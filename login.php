...
<body>
    <div class="container custom-container">
        <div class="card custom-card">
            <img src="assets/images/logo.png" alt="This is the logo" class="custom-logo">
            <div class="card-body">
            ...
            <div class="g-recaptcha" data-sitekey="<?= htmlspecialchars($siteKey) ?>"></div>
                    ...
                    <button type="submit" class="btn btn-primary w-100 py-2 fw-semibold shadow-sm" style="font-size: 1rem;">
    <i class="mdi mdi-login me-2"></i> Login
        ...
        style="font-weight: 500; transition: background-color 0.3s;">
            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/google/google-original.svg" alt="Google Icon" width="22" height="22">

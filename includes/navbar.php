...
<head>
  ...
  <style>
    ...
    nav.navbar {
      ...
      top: 0;
      z-index: 1030;
      background-color: rgb(22, 19, 100);
      /* <-- Change to your favorite color here! */
    }
  </style>
</head>
<nav class="navbar navbar-expand-lg navbar-dark  px-4 py-2 shadow-sm">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
      ...
      <li class="nav-item">
        <a class="nav-link text-white"
          href="<?= $role === 'admin' ? '../admin/index.php' : '../user/index.php' ?>">Dashboard</a>
      </li>
    ...
    <div class="d-flex align-items-center text-white">
      <!-- Cart Icon -->
      <a href="<?= $role === 'admin' ? '../admin/cart.php' : '../user/cart.php' ?>"
